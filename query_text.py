...
def calculate_similarity(query, video_features):
    ...
    for file_name in all_image_features:
        ...
        with torch.no_grad():
            ...
            logits_per_image = logit_scale * image_features[0] @ text_features.t()  # can scale it!
...
if __name__ == '__main__':
    ...
    while True:
        query = input("Query: ")
        similarity = calculate_similarity(query, out_file)
